...
namespace CalorieTrackerApp.Tests.TestCases
{
    public class ExceptionalTests
    {
        ...
        [Fact]
        public async Task<bool> Testfor_Get_Calorie_ById_NotNull()
        {
            //Arrange
            var res = false;
        ...
        [Fact]
        public async Task<bool> Testfor_Update_Calorie_NotNull()
        {
            //Arrange
            var res = false;
            string testName; string status;
        ...
        [Fact]
        public async Task<bool> Testfor_Delete_Calorie_NotNull()
        {
            //Arrange
            var res = false;
            string testName; string status;
            ...
            try
            {
                calorietrackerservice.Setup(repos => repos.DeleteCalorie(_Calorie.Id)).Returns(id);
        ...
        [Fact]
        public async Task<bool> Testfor_GetAll_Calorie_NotNull()
        {
            //Arrange
            var res = false;
            string testName; string status;
        ...
        [Fact]
        public async Task<bool> Testfor_Invalid_CalorieName_NotNull()
        {
            //Arrange
            var res = false;
            string testName; string status;
        ...
        [Fact]
        public async Task<bool> Testfor_Invalid_CalorieNote_NotNull()
        {
            //Arrange
            var res = false;
            string testName; string status;
